...
class fractal2D:
    ...
    def plot1(self, N, a, b, c, d, simplified, exact, h):
        ...
        colors=matplotlib.colors.ListedColormap(['red', 'green', 'blue', 'yellow', 'indigo', 'darkgoldenrod', 'pink','springgreen', 'black'])
        bounds=[0,1,2,3,4,5,6,7,10]
